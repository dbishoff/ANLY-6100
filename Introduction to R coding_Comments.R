## Data Analytics I Intro to R Coding
## Professor Courtney Paulson
## Fall 2020

# Basic Commands

### Note that using a "#" before a line will comment it out of your code (that 
### line won't be run)
### So as long as I put a "#" first, I can write whatever I want ~*@./
### I can also use this to put in valuable information, like mentioning you 
### can't turn in an assignment after the sample key is posted.
### But that's in the syllabus, so it shouldn't be valuable information.
###
###
### ...Right?

### To run a line of code in R, use the "Run" button at the top of this box 
### (upper righthand corner)
### Or (easier!) use "control+enter" on Windows or "command+enter" on Mac

## Probably the most important command to know is ?
## If you put a ? before a function, it will bring up the help file for that 
## function
## Example:
...
## The ls() ("list") function will always tell you what variables/objects you've
## already loaded into your R session
## More conveniently, though, in RStudio these are listed in the upper right 
## corner
...
# Common mathematical functions like square root (sqrt) will apply to the entire
# matrix
...
# rnorm: return a random number from a normal distribution with mean = 0 and 
# sd = 1 (but you can change these values!)
...
# The problem with runnining x=rnorm(50) is that if something goes wrong, you 
# cant troubleshoot. set.seed gives you a starting point and will generate The
# same random number every time.This will help in trouble shooting and could be
# removed later.
...
A
A[2,3]
# Returns specific values in the original matrix
# Row1,col2, row1,col4, row3,col2, row3,col4
A[c(1,3),c(2,4)]
A[1:3,2:4]
A[1:2,]
A[,1:2]
...
## Other fun (advanced!) plotting options:
...
## Whenever you want to use a specialized package, first install it like we briefly showed with swirl
...
## The "Auto" data set is a data set that comes automatically loaded in R
...
## You can also specify a subset of variables you want to actually use with ~
...
# How many cylinders as the 101 set.
Auto[101,"cylinders"]